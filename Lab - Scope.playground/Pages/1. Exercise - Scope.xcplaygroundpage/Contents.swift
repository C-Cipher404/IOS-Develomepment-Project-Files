...
// x is defined outside of the for loop, so it can be used and changed inside the loop and still used when the loop ends
// foo was defined inside a smaller scope so has to stay in that scope
